...
fn diagnostics(nb: &mut Notebook) {
    md(nb, "# Diagnostics Storybook");

    state!(nb, (), (Color32::from_hex("#35243E").unwrap()).into(), |ui, value| {
        ui.horizontal(|ui| {
    ...
    state!(nb, (), (Color32::from_hex("#CFC4D6").unwrap()).into(), |ui, value| {
        ui.horizontal(|ui| {
    ...
    state!(nb, (), (Color32::from_hex("#6B5AE6").unwrap(), Color32::from_hex("#FBF6F1").unwrap()), |ui, value| {
        let pair = &mut *value;
        ui.horizontal(|ui| {
    ...
    state!(nb, (), (Color32::from_hex("#6F6A79").unwrap(), Color32::from_hex("#35243E").unwrap()), |ui, value| {
        let pair = &mut *value;
        ui.horizontal(|ui| {
